...
{
    public static U8Reader<U8StreamSource> AsU8Reader(
        this Stream stream, bool disposeSource = true)
    {
    ...
    public static U8Reader<U8FileSource> AsU8Reader(
        this SafeFileHandle handle, bool disposeSource = true)
    {
    ...
    public static U8Reader<U8SocketSource> AsU8Reader(
        this Socket socket, SocketFlags flags = SocketFlags.None, bool disposeSource = false)
    {
    ...
    public static U8Reader<U8WebSocketSource> AsU8Reader(
        this WebSocket ws, bool disposeSource = false)
    {
    ...
    public static U8LineReader<U8StreamSource> ReadU8Lines(
        this Stream stream, bool disposeSource = true)
    {
        ThrowHelpers.CheckNull(stream);
    ...
    public static U8LineReader<U8FileSource> ReadU8Lines(
        this SafeFileHandle handle, bool disposeSource = true)
    {
        ThrowHelpers.CheckNull(handle);
