...
public class Dictionaries
{
    ...
    private readonly Dictionary<U8String, U8String> Dict = new(U8Comparison.AsciiIgnoreCase);
    private FrozenDictionary<U8String, U8String> FrozenDict = null!;
    private readonly ConcurrentDictionary<U8String, U8String> ConcurrentDict = new(U8Comparison.AsciiIgnoreCase);
    private readonly Dictionary<string, string?> DictUtf16 = new(StringComparer.OrdinalIgnoreCase);
    private FrozenDictionary<string, string?> FrozenDictUtf16 = null!;
    private readonly ConcurrentDictionary<string, string?> ConcurrentDictUtf16 = new(StringComparer.OrdinalIgnoreCase);
    ...
    public void Setup()
    {
        ...
        FrozenDict = Dict.ToFrozenDictionary(U8Comparison.AsciiIgnoreCase);
        FrozenDictUtf16 = DictUtf16.ToFrozenDictionary(StringComparer.OrdinalIgnoreCase);
