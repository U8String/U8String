...
public class AsciiIgnoreCaseConverter
{
    ...
    public void CommonPrefixLength_CalculatesCorrectLength()
    {
        ...
        var left = "Hell."u8;
        var right = "HELLO"u8;
        var commonPrefixLength = U8Comparison.AsciiIgnoreCase.CommonPrefixLength(left, right);
        Assert.Equal(4, commonPrefixLength);

        left = "Hello"u8;
        right = "HELLO"u8;
        commonPrefixLength = U8Comparison.AsciiIgnoreCase.CommonPrefixLength(left, right);
